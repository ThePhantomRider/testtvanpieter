...
def control_thread():
    ...
    while not stop_event.is_set():
        ...
        if SHOW_PREVIEW:
            ...
            cv2.putText(
                frame, f"steer={steering:+.2f} throttle={throttle:.2f}",
