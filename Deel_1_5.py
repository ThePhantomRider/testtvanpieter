...
# Beide op 1.0 = elke gedetecteerde bocht stuurt vol (geen meeschalen meer).
# Zet STEER_MIN lager als je flauwe bochten weer zachter wilt.
STEER_MIN = 1.0           # minimale stuurwaarde zodra er een geldige bocht is
